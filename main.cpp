...
int main()
{
	...
	printf("Enter the corresponding no");gotoxy(22,19);textcolor(10);
	...
	printf("4.Delete the records");gotoxy(22,27);
	printf("5.feedback");gotoxy(22,29);
	printf("6.Exit from the program");gotoxy(25,30);
	fflush(stdin);
	scanf("%c",&d);
	switch(d)
	{
		case '1':
			...
			if(c=='o')
			{
				...
				printf("ADDING NEW O.P.D.PATIENT RECORD");textcolor(15);
				gotoxy(21,12);
				printf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
				newrecord(s);
				newrecord1();
				...
				fclose(fp);
				 ...
				 int contact;
				 textcolor(11);
				 printf("enter patient's family contact no from any government records \n an sms will be provided about stability and address \n of hospital");
		...
		case '5':
			...
			printf("THANK U");gotoxy(30,26);
		       //	printf("SAVING UR SETTINGS"); gotoxy(30,28);
			printf("BYE...........");
			getch();
			exit(1);
			break;
		...
		case '4':
			{
				...
				edit1();
				gotoxy(25,46);
				printf("Press `ENTER' to delete this record");
				getch();
				fclose(fp);
				fclose(f1);
				remove(fn1);
		...
		case '3':
			{       label6:
				...
				printf("Enter the corresponding no");gotoxy(22,19);textcolor(3);
				...
				printf("4.Recordsin paricular date");gotoxy(22,27);
				...
				case '1':
					...
					printf("Press");textcolor(15+128);
					printf(" `Enter' ");    textcolor(3);
					printf("to continue");
					getch();
					while(fread(&p,sizeof(alka),1,fp))
					{
		...
		case '4':
			...
			default:
				...
				printf("Wrong choice");gotoxy(22,13);textcolor(15);
...
void print()
{
	...
	printf("Patient no:");gotoxy(21,14);textcolor(11);
	printf("%d",p.sn);gotoxy(10,17);textcolor(2);
	printf("Name:");gotoxy(15,17);textcolor(11);
	printf(" %s",p.name);gotoxy(10,20);textcolor(2);
	printf("Address:");gotoxy(18,20);textcolor(11);
	printf(" %s",p.address);gotoxy(10,23);textcolor(2);
	printf("Age:");gotoxy(15,23);textcolor(11);
	printf("%d",p.age);gotoxy(10,26);textcolor(2);
	printf("Sex:");gotoxy(14,26);textcolor(11);
	printf(" %c",p.ch);gotoxy(10,29);textcolor(2);
	printf("Date of Reg.:");gotoxy(24,29);textcolor(11);
	printf("%s",p.date);gotoxy(10,32);textcolor(2);
	printf("Room no:");gotoxy(18,32);textcolor(11);
	printf(" %d",p.roomno);gotoxy(10,35);textcolor(2);
	printf("Department:");gotoxy(21,35);textcolor(11);
	printf(" %s",p.department);gotoxy(10,38);textcolor(2);
	printf("Category:");gotoxy(19,38);textcolor(11);
	printf(" %s",p.category);
...
void edit1()
{
	...
	printf("Details:");gotoxy(18,41);textcolor(11);
	printf(" %s",p.recommendation);gotoxy(10,45);textcolor(4);
	printf("Press");textcolor(15+128);
	printf(" `Enter'");textcolor(4);
	...
	for(z=0,i=0,k=11;p.testfee[z]!=0;i++,z++)
	{
		...
		printf("%d)",i+1);      textcolor(11);
		printf(" %s",&p.test[z][0]);textcolor(15);gotoxy(40,k);
		printf("Rs.%0.2f",p.testfee[z]);
		k=k+2;
	}
	gotoxy(20,k+2); textcolor(11);
	printf("Total charge=");textcolor(15);
	printf("Rs.%0.2f",p.totalfee);
	gotoxy(20,k+4);textcolor(11);
	printf("Total Deposited:");textcolor(15);
...
{       int i;
	...
	printf("::ADDING SERVICES::");gotoxy(45,11);textcolor(15);
	printf("----------------------------");
...
void mainscreen()
{
	...
	printf("SRSS HOSPITAL");
	gotoxy(27,6);textcolor(6);
	printf("Chikkbanvara, Bengaluru");
